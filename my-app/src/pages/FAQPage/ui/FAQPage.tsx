...
export const FAQPage: React.FC = () => {
  ...
  const leftColumnItems = [faqItems[0], faqItems[3]];
  const centerColumnItems = [faqItems[1], faqItems[4]];
  const rightColumnItems = [faqItems[2], faqItems[5]];
