        ...
        <div className={styles.container}>
          ...
          <div className={styles.tournamentCard}>
            ...
            <p className={styles.tournamentDescription}>
              Весна 2026 — время новых форматов. Приглашаем студентов принять участие в турнире по фиджитал-баскетболу.
            </p>
            ...
            <p className={styles.tournamentResult}>
              Победитель определяется по сумме двух этапов. Регистрация уже открыта. Стань частью истории студенческого фиджитал-движения!
            </p>
